  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent
        ...
        className="flex h-[70vh] max-h-[80vh] w-[min(92vw,56rem)] max-w-full flex-col gap-0 rounded-none border border-border bg-bg-elevated p-0 shadow-2xl ring-1 ring-white/10 sm:max-w-[56rem]"
      >
