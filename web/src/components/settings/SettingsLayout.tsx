            ...
            {items.map((item) => {
              ...
              return (
                <div
                  ...
                  className={`flex items-center justify-between gap-2.5 rounded-lg border border-border bg-sidebar-bg px-3 py-2 transition-colors hover:bg-surface-bg ${
                ...
                >
                  ...
                  <div className="flex shrink-0 items-center gap-1.5">
                    <select
                      ...
                      className="rounded-lg border border-border bg-sidebar-bg px-2 py-1 text-xs text-text-primary focus:border-[#6c8cff]/40 focus:outline-none"
                    >
                      {slots.map((s) => (
                    ...
                    {overrides[item.id] !== undefined && (
                      <Button type="button" variant="ghost" size="sm" className="hover:bg-surface-bg" onClick={() => { resetItem(item.id); setChanged((v) => v + 1) }}>
                        重置
                      </Button>
                    )}
                  </div>
