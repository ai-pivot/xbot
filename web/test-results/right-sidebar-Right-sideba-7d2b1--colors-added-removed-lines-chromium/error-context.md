...
- Name: right-sidebar.spec.ts >> Right sidebar (Spec 6) >> diff viewer colors added/removed lines
- Location: e2e/right-sidebar.spec.ts:85:3
...
Call log:
  - waiting for locator('.flex.h-full.w-12.shrink-0.flex-col').last().locator('button[aria-pressed]').nth(2)
