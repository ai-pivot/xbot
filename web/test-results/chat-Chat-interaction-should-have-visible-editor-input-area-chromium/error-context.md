...
- Name: chat.spec.ts >> Chat interaction >> should have visible editor/input area
- Location: e2e/chat.spec.ts:19:3
...
Locator: locator('.tiptap, textarea')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.tiptap, textarea')
