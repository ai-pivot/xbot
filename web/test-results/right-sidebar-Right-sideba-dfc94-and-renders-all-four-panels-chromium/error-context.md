...
- Name: right-sidebar.spec.ts >> Right sidebar (Spec 6) >> expands/collapses and renders all four panels
- Location: e2e/right-sidebar.spec.ts:32:3
...
Call log:
  - waiting for locator('.flex.h-full.w-12.shrink-0.flex-col').last() to be visible
