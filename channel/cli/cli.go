...
func (c *CLIChannel) Start() error {
	...
	c.wg.Add(1)
	clipanic.Go("CLIChannel.handleProgressDrain", c.handleProgressDrain)

	// 启动 unified async drain goroutine: single sender to p.msgs
	c.wg.Add(1)
	clipanic.Go("CLIChannel.handleAsyncDrain", c.handleAsyncDrain)
	...
	if c.runnerAutoConnect != nil {
		...
		clipanic.Go("CLIChannel.runnerAutoConnect", func() {
...
func (c *CLIChannel) CheckUpdateAsync() {
	...
	clipanic.Go("CLIChannel.CheckUpdateAsync", func() {
