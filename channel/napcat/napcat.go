...
func NewNapCatChannel(cfg NapCatConfig, msgBus *bus.MessageBus) *NapCatChannel {
	return &NapCatChannel{
		WSChannelBase: ch.NewWSChannelBase(1000, napcatQuickDisconnectWindow, napcatQuickDisconnectCount),
		config:        cfg,
		msgBus:        msgBus,
...
// Send 发送消息到 NapCat
func (n *NapCatChannel) Send(msg ch.OutboundMsg) (string, error) {
