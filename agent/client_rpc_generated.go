// Code generated by cmd/genclient/main.go. DO NOT EDIT.
...
func (c *Client) SetChatLLM(chatID, provider string, llmCfg config.LLMConfig) error {
	return c.call(MethodSetChatLLM, setChatLLMReq{ChatID: chatID, Provider: provider, Config: llmCfg}, nil)
}
...
func (c *Client) SetUserThinkingMode(senderID, mode string) error {
...
func (c *Client) SetDefaultSubscription(id, chatID string) error {
...
func (c *Client) UpdatePerModelConfig(id, model string, pmc protocol.PerModelConfig) error {
	return c.call(MethodUpdatePerModelConfig, updatePerModelConfigReq{ID: id, Model: model, Config: pmc}, nil)
}
...
func (c *Client) ClearMemory(ctx context.Context, channelName, chatID, targetType, senderID string) error {
	return c.call(MethodClearMemory, clearMemoryReq{Channel: channelName, ChatID: chatID, TargetType: targetType, SenderID: senderID}, nil)
}
...
func (c *Client) InspectInteractiveSession(ctx context.Context, roleName, channelName, chatID, instance string, tailCount int) (string, error) {
	var r string
	return r, c.call(MethodInspectInteractiveSession, inspectInteractiveSessionReq{RoleName: roleName, ChannelName: channelName, ChatID: chatID, Instance: instance, TailCount: tailCount}, &r)
}
