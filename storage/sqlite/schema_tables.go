...
// schemaCore contains tenants and session messages tables.
const schemaCore = `
...
// schemaMemory contains core memory blocks and archival memory tables.
const schemaMemory = `
...
// schemaEvents contains event history and FTS tables/triggers.
const schemaEvents = `
...
// schemaUsers contains user profiles, settings, and LLM config tables.
const schemaUsers = `
...
// schemaRunners contains runner tokens and runners tables.
const schemaRunners = `
...
// schemaShared contains shared registry for skills and agents.
const schemaShared = `
...
// schemaJobs contains cron jobs and event triggers tables.
const schemaJobs = `
